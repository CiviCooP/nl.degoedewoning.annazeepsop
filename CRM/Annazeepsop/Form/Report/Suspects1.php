 ...
 *
 */
class CRM_Annazeepsop_Form_Report_Suspects1 extends CRM_Report_Form {
  ...
  function preProcess() {
    CRM_Utils_System::setTitle(ts('Dubbele contacten Anna Zeepsop 1e regel (dedupe regel ID 7)'));
    parent::preProcess();
  }
  ...
  function from() {
    $this->_from = "FROM dgw_suspects1 suspects
