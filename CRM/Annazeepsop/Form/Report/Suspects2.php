 ...
 *
 */
class CRM_Annazeepsop_Form_Report_Suspects2 extends CRM_Report_Form {
  ...
  function preProcess() {
    CRM_Utils_System::setTitle(ts('Dubbele contacten Anna Zeepsop 2e regel (dedupe regel ID 8)'));
    parent::preProcess();
  }
